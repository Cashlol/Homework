...
<input type="text" id="input" onkeyup="search()" placeholder="Search Members" title="Type a name">
<div id="table">
<table>
<thead>
    <tr>
...
<tr>
	...
	<td><a class="buttonDelete" href="memberlist.php?sid=<?php echo $row['member_id'];?>"onclick="return confirm('Are you sure you want to delete this ?')"><i class="fa-solid fa-delete-left" title="Delete" style="color:red"></i></a></td>
</tr>
