...
<?php
$result=mysqli_query($connect,"SELECT * from reviews join member on reviews.member_id=member.member_id");
...
<input type="text" id="input" onkeyup="search()" placeholder="Search Review" title="Type a member name">
<div id="table">
<table>
  <thead>
    <tr>
...
<tr>
	...
	<td><a href="managereview.php?revid=<?php echo $row['rev_id'];?>"onclick="return confirm('Are you sure you want to delete this ?')"><i class="fa-solid fa-delete-left" title="Delete" style="color:red"></i></a></td>
</tr>
<?php } ?>
